    ...
    <main className="min-h-screen pt-24 pb-24 md:pb-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold">Find the perfect package in 60 seconds</h1>
          <p className="text-sm text-muted-foreground mt-3 max-w-xl">
            Answer 4 quick questions and we&apos;ll suggest the best collaboration package for your goal, budget, and timeline — plus smart add-ons to maximise ROI.
          </p>
        </div>
        <PackageRecommender />
      </div>
